...
SECRET_KEY = 'django-insecure-y066n54_f!gqsn4%@51w$e5-hvbj3w5*&kpyj+wxxa)u5zzi)j'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # create this folder manually
]
...
JAZZMIN_SETTINGS = {
    ...
    "sidebar": {
        "show_filters": True,  # ✅ MUST BE True to show filters on sidebar
    },
}